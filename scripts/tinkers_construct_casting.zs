...
Casting.addTableRecipe(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:steam_engine"}), <forge:bucketfilled>.withTag({FluidName: "steam", Amount: 1000}), <liquid:modularium>, 144, true, 20);
